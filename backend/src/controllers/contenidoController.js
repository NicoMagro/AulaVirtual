...
const crearBloque = async (req, res) => {
  try {
    ...
    const { aula_id, tipo, contenido, orden } = req.body;
    const usuario_id = req.usuario.id;
    ...
    const resultado = await db.query(
      `INSERT INTO contenido_aulas (aula_id, tipo, contenido, orden, creado_por)
       VALUES ($1, $2, $3, $4, $5)
       RETURNING *`,
      [aula_id, tipo, contenido, orden, usuario_id]
    );
